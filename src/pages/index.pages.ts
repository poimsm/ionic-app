...
export { TiendaNuevoPage } from './tienda-nuevo/tienda-nuevo';
...
export { OnceSopresaContentPage } from './once-sopresa-content/once-sopresa-content';
export { OnceSopresaPage } from './once-sopresa/once-sopresa';
...
export { LoginNamePage } from './login-name/login-name';
export { LoginEmailPage } from './login-email/login-email';
export { LoginPasswordPage } from './login-password/login-password';
