...
import { BikeDireccionPage } from '../bike-direccion/bike-direccion';
import { google } from '@google/maps';

@IonicPage()
@Component({
  selector: 'page-bike-intro',
  templateUrl: 'bike-intro.html',
})
export class BikeIntroPage {
  ...
  openDireccion() {
    this.navCtrl.push(BikeDireccionPage);
  }
}
